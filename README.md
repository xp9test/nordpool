...
| `nordpool_dashboard.yaml` | ApexCharts-based dashboard card that visualizes today's energy prices. It highlights the cheapest 15-minute intervals with red markers, making it easy to track optimal usage times. |
